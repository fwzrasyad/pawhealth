                  ...
                  child: Column(
                    children: [
                      Icon(
                        ...
                        size: 40,
                        color: _hasAttachment ? AppColors.primary : Colors.grey,
                      ),
                      SizedBox(height: 8),
                      Text(
                        _hasAttachment ? 'File Uploaded' : 'Tap to upload Document/Photo',
                        style: TextStyle(
                          color: _hasAttachment ? AppColors.primary : Colors.grey.shade600,
      ...
      child: Row(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              color: date != null ? AppColors.darkText : Colors.grey.shade400,
            ),
          ),
